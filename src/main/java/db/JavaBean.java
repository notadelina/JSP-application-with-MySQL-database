...
public class JavaBean {
	...
	public void connect() throws ClassNotFoundException, SQLException, Exception {
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/facultate?useSSL=false", "root", "Berberita@10");
	...
	public void adaugaCurs(String Nume, String Dificultate, String Prezenta)
		...
		if (con != null) {
			try {
				...
				stmt.executeUpdate("insert into cursuri(Nume, Dificultate, Prezenta) values('" + Nume + "'  , '" + Dificultate + "', '" + Prezenta + "');");
	...
	public void adaugaAngajat(String Nume, String Prenume, String Departament, String Pozitie)
			throws SQLException, Exception {
		if (con != null) {
			try {
				...
				Statement stmt;
				stmt = con.createStatement();
				stmt.executeUpdate("insert into angajati(Nume, Prenume, Departament, Pozitie) values('" + Nume + "'  , '" + Prenume + "', '" + Departament + "' , '" + Pozitie +"');");
	...
	public void adaugaSala(int idcursuri, int idangajati, String NumeSala, String Capacitate, String Videoproiector)
			throws SQLException, Exception {
		if (con != null) {
			try {
				// create a prepared SQL statement
				Statement stmt;
				stmt = con.createStatement();
				stmt.executeUpdate("insert into sala(idcursuri, idangajati, NumeSala, Capacitate, Videoproiector) values('" + idcursuri + "'  , '" + idangajati + "', '" + NumeSala + "', '" + Capacitate + "', '" + Videoproiector + "');");
	...
	public ResultSet vedeSala() throws SQLException, Exception {
		ResultSet rs = null;
		try {
			String queryString = ("select a.Nume NumeCurs, a.Dificultate, a.Prezenta, b.Nume NumeAngajat, b.Prenume PrenumeAngajat, b.Departament, b.Pozitie, c.idsala, c.idangajati idangajati_sala, c.idcursuri idcursuri_sala, c.NumeSala, c.Capacitate, c.Videoproiector from cursuri a, angajati b, sala c where a.idcursuri = c.idcursuri and b.idangajati = c.idangajati;");
			Statement stmt = con.createStatement(/*ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY*/);
			rs = stmt.executeQuery(queryString);
		} catch (SQLException sqle) {
			error = "SQLException: Interogarea nu a fost posibila.";
	...
	public ResultSet intoarceLinie(String tabela, int ID) throws SQLException, Exception {
		...
		try {
			// Execute query
			String queryString = ("SELECT * FROM " + tabela + " where idcursuri=" + ID + ";");
			Statement stmt = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
	...
	public ResultSet intoarceSalaId(int ID) throws SQLException, Exception {
		ResultSet rs = null;
		try {
			// Execute query
			String queryString = ("select a.Nume NumeCurs, a.Dificultate, a.Prezenta, b.Nume NumeAngajat, b.Prenume PrenumeAngajat, b.Departament, b.Pozitie, c.idsala, c.idangajati idangajati_sala, c.idcursuri idcursuri_sala, c.NumeSala, c.Capacitate, c.Videoproiector FROM cursuri a, angajati b, sala c WHERE a.idcursuri = c.idcursuri AND b.idangajati = c.idangajati and idsala = '" + ID + "';");
			Statement stmt = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
			rs = stmt.executeQuery(queryString); //sql exception
		} catch (SQLException sqle) {
			error = "SQLException: Interogarea nu a fost posibila.";
