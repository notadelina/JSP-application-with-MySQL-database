...
<body>
    ...
    <%
        jb.connect();
        int aux = java.lang.Integer.parseInt(request.getParameter("idcursuri"));
        String Nume = request.getParameter("Nume");
        String Dificultate = request.getParameter("Dificultate");
        String Prezenta = request.getParameter("Prezenta");

        String[] valori = {Nume, Dificultate, Prezenta};
        String[] campuri = {"Nume", "Dificultate", "Prezenta"};
        jb.modificaTabela("cursuri", "idcursuri", aux, campuri, valori);
        jb.disconnect();
    %>
